export default function counter() {
	...
	const cartNumberElement = document.querySelector('.header__cart-info-count');
	let cartNumber = Number(cartNumberElement.innerHTML);
	...
	products.forEach(product => {
		const numberElement = product.querySelector('.product__count');
		const priceElement = product.querySelector('.product__price-value');
		const closeElement = product.querySelector('.product__delete');
